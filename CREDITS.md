...
Current play zip is **vr445**. [README Play](README.md#play-vr445---the-one-to-grab) - [Latest release](https://github.com/no6969el/GEVR/releases/latest). How to file bugs: [CONTRIBUTING.md](CONTRIBUTING.md). Whose license is whose: [LICENSE-MAP.md](LICENSE-MAP.md).
...
- [CONTRIBUTING.md](CONTRIBUTING.md) - how to play vr445 and file bugs
- [LICENSE-MAP.md](LICENSE-MAP.md) - whose license is whose
- [README Play](README.md#play-vr445---the-one-to-grab) | [Releases/latest](https://github.com/no6969el/GEVR/releases/latest)
