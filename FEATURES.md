...
What you can do in **vr445.2** today (player language):
...
- **Janus spawn (#82)** KEEP in this cut; Frigate water (#80) still open on Latest
...
- Use **[vr445.2 Latest](https://github.com/no6969el/GEVR/releases/latest)** (`GEVR-Beta-vr445.2-win64.zip`). Older tag pages stay; their **zips were stripped** where we pulled them.
...
1. Grab **[`GEVR-Beta-vr445.2-win64.zip`](https://github.com/no6969el/GEVR/releases/latest)** from [Latest](https://github.com/no6969el/GEVR/releases/latest) / [vr445.2](https://github.com/no6969el/GEVR/releases/tag/vr445.2) (no ROM in the archive).
