...
rem SKYINF chair PASS 2026-09-22: cloud stay-put. Dig =0.
set GETV_VR_SKYINF=1
rem SKYWATERPIN: Frigate coverage dig. Chair FAIL 2026-09-22 head-locked/crazy.
rem Keep =0 on ship until stay-put+texture PASSes. Dig =1 for coverage A/B only.
